  ...
  <div class="flex min-h-full flex-1 flex-col justify-center px-6 py-12 mt-20 lg:px-8">
    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
      <form class="space-y-6" action="#" method="POST">
        ...
        <div>
          <div class="flex items-center  justify-between">
            ...
            <div class="text-sm">
              <a href="#" class="font-semibold text-[#20c05c] hover:text-[#1a9e4e]">Forgot password?</a>
            </div>
          </div>
          <div class="mt-2">
      ...
      <p class="mt-10 text-center text-sm text-gray-500">
        ...
        <NuxtLink to="/signup" class="font-semibold leading-6 text-[#20c05c] hover:text-[#1a9e4e]">
          Sign up
        </NuxtLink>
      </p>
    </div>
