<template>
    <section class="relative isolate overflow-hidden bg-white px-6 py-24 sm:py-32 lg:px-8">
      ...
      <div class="mx-auto max-w-2xl lg:max-w-4xl">
        <h2 class="text-center h-12 font-semibold text-5xl">Testimonials</h2>
        ...
        <figure class="mt-10">
          ...
          <figcaption class="mt-10">
            ...
            <div class="mt-4 flex flex-col items-center justify-center space-x-3 text-base">
              <div class="font-semibold text-gray-900">Judith Black</div>


              <div class="flex items-center justify-evenly space-x-6 p-10">

                <svg viewBox="0 0 2 2" width="6" height="6" aria-hidden="true" class="fill-[#20c05c]">
